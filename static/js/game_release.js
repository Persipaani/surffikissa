...
var Game = function () {
    ...
    this.previous_y = 55,
    this.previous_x = 0,
    this.spacebar_down = false, //ettei voi hyppiÃ¤ spacebar pohjassa
    ...
    //CelleissÃ¤ x ja y meinaa koordinaatteja sheetissÃ¤ (vasempaan ylÃ¤kulmaan):
    // HUOM!!! CELLEJÃ„ TULEE AINA OLLA YHTÃ„ MONTA JOKAISELLE ACTIONILLE, MUUTEN KUSEE!
    ...
    //TÃ¤mÃ¤ on sijaintidataa pelikentÃ¤llÃ¤:
    ...
    this.CollisionAction = {
        //TietÃ¤Ã¤, mitÃ¤ tÃ¶rmÃ¤yksessÃ¤ tehdÃ¤Ã¤n:
        ...
        PossibleCollision: function (sprite, colliding) {
            //Kummankin pitÃ¤Ã¤ olla nÃ¤kyvillÃ¤ ja ei saa olla sama:
            if (sprite != colliding && sprite.visible && colliding.visible && game.player_jumping == false) {
                //Kummassakaan ei saa olla tÃ¶rmÃ¤ys kÃ¤ynnissÃ¤:
                if (!sprite.collided && !colliding.collided) {
                    //Tarkistuksen tehostamiseksi kÃ¤ydÃ¤Ã¤n lÃ¤pi vain objektit pelaajan kohdalla:
        ...
        Collided: function (sprite, colliding, context) {
            //MÃ¤Ã¤ritellÃ¤Ã¤n boundingboksin rajat(boski pienennetty 5pikseliÃ¤ reunoista):
            //TÃ¤ssÃ¤ pelissÃ¤ vain player tÃ¶rmÃ¤Ã¤, joten arvot sieltÃ¤:
...
Game.prototype = { //prototype tarkoittaa js:ssÃ¤ periytymistÃ¤, lol
    ...
    CalculateAnimation: function (time) {
        if (game.paused == true && game.onmenu == false) {
            ...
            if (game.breath < 1 && game.lost == false) {
                ...
                //NÃ¤mÃ¤ pitÃ¤Ã¤ timeouttaa hetken pÃ¤Ã¤hÃ¤n, ettÃ¤ background ehtii piirtyÃ¤ kerran:
    ...
    TogglePause: function () {
        ...
        if (this.paused == true) {
            ...
            if (this.soundOn) {
                //console.log("Ã¤Ã¤niÃ¤ on pÃ¤Ã¤llÃ¤: ", this.playing_sounds.length)
                for (var i = 0; i < this.playing_sounds.length; ++i) {
                    //console.log("Ã¤Ã¤ni pÃ¤Ã¤Ã¤lle: ", this.playing_sounds[i]);
    ...
    UpdateSprites: function (time) {
        //Suorittaa collision checkin ja muut mahdolliset kÃ¤yttÃ¤ytymiset.
        var sprite;
        for (var n = 0; n < this.sprites.length; ++n) {
            sprite = this.sprites[n];
    ...
    SpriteOnView: function (sprite) {
        ...
        if (sprite.x - sprite.offset < 0) {
            //Jos nÃ¤ytÃ¶n ulkopuolella takarajasta se voidaan sijoittaa uudelleen jonnekin:
    ...
    RePosition: function (sprite) {
        ...
        if (this.previous_x < this.MAXSPRITESPAWN) {
            //lasketaan lisays (minimissÃ¤Ã¤n +this.X_LIMIT + 50, maksimissaan + 50 ja edellinen:
        ...
        if (this.previous_y < (this.Y_LIMIT - 55)) {
            //lasketaan lisays (minimissÃ¤Ã¤n +10, maksimissaan + 55):
    ...
    CalculatePlayer: function (time) {
        ...
        //Animoidaan eri tavalla liikkeessÃ¤:
        ...
        if (this.player.y > this.Y_LIMIT) {
            ...
            //HenkeÃ¤ tulee hitaasti lisÃ¤Ã¤ 40 asti
        ...
        //Kiihtyvyys resetoidaan lÃ¤hellÃ¤ nollaa:
    ...
    //DRAWING:
    Draw: function (time) {
        //Jos peli ei ole alku- tai loppumenussa piirretÃ¤Ã¤n kaikki muu
    ...
    DrawBackground: function () {
        ...
        //Tausta piirretÃ¤Ã¤n 2 kertaa yhdellÃ¤ ajalla, jotta scrollaus jatkuva:
...
window.onkeydown = function (e) {
    ...
    // ei voi liikkua tÃ¶rmÃ¤yksen aikana tai  kun on kuollut
